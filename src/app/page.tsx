      ...
      <section id="racing" style={{padding:'100px 60px', backgroundColor:'#0f2847'}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'80px', alignItems:'start', marginBottom:'72px'}}>
          ...
          <div style={{display:'flex', flexDirection:'column', gap:'2px'}}>
            ...
            <div style={{position:'relative', height:'420px', overflow:'hidden', backgroundColor:'#0B1F3A'}}>
              <img src="/images/IMG_0965.jpg" alt="Blake Fisher — 1st place podium at Winter Park" style={{width:'100%', height:'100%', objectFit:'contain', objectPosition:'center', display:'block'}}/>
